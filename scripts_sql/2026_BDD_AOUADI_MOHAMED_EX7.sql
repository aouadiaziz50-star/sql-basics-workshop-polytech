...
-- et detecter les depassements entre l'heure de fin prevue
-- et la date de fin effective.
...
SELECT
    ...
    CASE
        WHEN st.date_fin_effective IS NULL
        THEN 'NON_TERMINE'
